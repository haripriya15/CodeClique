  ...
  const onChange = e => setFormData({...formData, [e.target.name]: e.target.value });
    ...
    <Fragment>
        ...
        <h1 class="large text-primary">
         Add An Education</h1>
      <p class="lead">
        <i class="fas fa-code-branch"></i> Add any school or course that you have attended
      </p>
      ...
      <form class="form" onSubmit= { e =>{
       ...
       addEducation(formData,history);
        ...
        <div class="form-group">
          <input type="text" placeholder="* school or course" name="school" 
        ...
        <div class="form-group">
          <textarea
            ...
            cols="30"
            rows="5"
            placeholder="Program Description or any Course details"
